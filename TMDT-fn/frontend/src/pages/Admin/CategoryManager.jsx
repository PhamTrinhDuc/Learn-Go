...
const CategoryManager = () => {
    ...
    const handleSave = async () => {
        ...
        try {
            ...
            const response = await fetch(`${import.meta.env.VITE_SERVER_API}/api/form-templates`, {
                method: 'POST',
                headers: {
    ...
    return (
        <div className="category-manager">
            {toast.show && (
                <div className={`toast ${toast.type === 'error' ? 'bg-red-500' : ''}`} style={{ backgroundColor: toast.type === 'error' ? '#ef4444' : '#10b981' }}>
            ...
            <div className="category-manager-header">
                ...
                <p>Định nghĩa cấu trúc thông số kỹ thuật cho các dòng sản phẩm của bạn.</p>
            </div>
